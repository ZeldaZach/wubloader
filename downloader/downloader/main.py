	...
	def _get_segment(self):
		...
		try:
			...
			if file_created:
				...
				segment_duration_downloaded.labels(partial="True", stream=self.channel, variant=self.stream).inc(self.segment.duration)
			raise ex_type, ex, tb
		else:
			...
			segment_duration_downloaded.labels(partial="False", stream=self.channel, variant=self.stream).inc(self.segment.duration)
